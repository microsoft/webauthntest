...
(function () {
    ...
    */
    ...
    html += '             <dt>AAGUID</dt><dd><div class="mono-block aaguid-mono-block"><div class="aaguid-icon-wrap"><img alt="authenticator icon" class="aaguid-icon" id="' + aaguidSpanId + '_icon" src="" style="display:none;" /></div><pre class="mono hex-mono" id="' + aaguidSpanId + '"></pre><div class="mono-actions"><button class="mdl-button mdl-js-button mdl-js-ripple-effect copy-to-clipboard aaguid-copy-id" data-copy-span="' + aaguidSpanId + '" data-copy-label="AAGUID" title="Copy AAGUID"><i class="material-icons">content_copy</i></button></div></div></dd>';
